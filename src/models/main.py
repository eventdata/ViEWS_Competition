...
parser.add_argument('--batch_size', type=int, default=96, help='batch size for training and validation (default: 50)')
...
parser.add_argument('--window', type=int, default=36, help='window length')
...
# adj_mx = get_adj_matrix('data/raw/priogrid_AF.csv')
